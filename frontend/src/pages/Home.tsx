        ...
        <div className="space-y-32 py-12">
            ...
            <section className="text-center space-y-8 relative">
                ...
                >
                    ...
                    <motion.h1
                        className="text-6xl md:text-8xl font-heading text-foreground mb-4 overflow-hidden"
                        variants={wordVariants}
                        initial="hidden"
                        animate="visible"
                    >
                        {Array.from("Satya").map((char, index) => (
                    ...
                    <motion.p
                        ...
                        className="text-3xl md:text-5xl font-light text-muted-foreground leading-tight"
                    >
